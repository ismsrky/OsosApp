...
namespace OsosApp.Helper
{
    internal static class Ext
    {
        ...
        /// <summary>
        /// Returns if the given value is not guid.
        /// </summary>
        /// <param name="value">The value to be checked.</param>
        /// <returns>bool</returns>
        public static bool IsNotGuid(this object value)
        {
            return !IsGuid(value);
        }
        #endregion
        ...
        /// <summary>
        /// Converts the given value to float. Returns null if value is null.
        /// </summary>
        /// <param name="value">The value to be converted.</param>
        ...
        /// <summary>
        /// Round down datetime to nearest timespan.
        /// For example, if timespan 1 minute it rounds down to first full 1 minute
        /// 9:36:45.187 -> 9:36:45.00
        /// </summary>
        /// <param name="dt">Datetime which need to be rounded</param>
        /// <param name="d">Timespan which use like round sign(check summary)</param>
        /// <returns>DateTime</returns>
        ...
        /// <summary>
        /// Round up datetime to nearest timespan.
        /// For example, if timespan 1 minute it rounds up to first full 1 minute
        /// 9:36:45.187 -> 9:36:46.00
        /// </summary>
        /// <param name="dt">Datetime which need to be rounded</param>
        /// <param name="d">Timespan which use like round sign(check summary)</param>
        /// <returns>DateTime</returns>
        ...
        {
            long num1 = dt.Ticks % d.Ticks;
            long num2 = num1 != 0L ? d.Ticks - num1 : 0L;
            return new DateTime(dt.Ticks + num2, dt.Kind);
        }
        #endregion
